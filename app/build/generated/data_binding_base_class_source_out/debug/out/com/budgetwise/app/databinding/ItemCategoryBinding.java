...
public final class ItemCategoryBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView tvMonthlyLimit;
  ...
  private ItemCategoryBinding(@NonNull MaterialCardView rootView, @NonNull ImageButton btnDelete,
      ...
      @NonNull TextView tvMonthlyLimit, @NonNull View vColour) {
    this.rootView = rootView;
    this.btnDelete = btnDelete;
    this.btnEdit = btnEdit;
    this.tvCategoryName = tvCategoryName;
    this.tvMonthlyLimit = tvMonthlyLimit;
  ...
  public static ItemCategoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.tvMonthlyLimit;
      TextView tvMonthlyLimit = ViewBindings.findChildViewById(rootView, id);
      if (tvMonthlyLimit == null) {
        break missingId;
      }

      id = R.id.vColour;
      View vColour = ViewBindings.findChildViewById(rootView, id);
      if (vColour == null) {
        break missingId;
      }

      return new ItemCategoryBinding((MaterialCardView) rootView, btnDelete, btnEdit,
          tvCategoryName, tvMonthlyLimit, vColour);
    }

...
public final class ItemExpenseBinding implements ViewBinding {
  ...
  private ItemExpenseBinding(@NonNull MaterialCardView rootView, @NonNull ImageView ivReceiptIcon,
  ...
  public static ItemExpenseBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemExpenseBinding((MaterialCardView) rootView, ivReceiptIcon, tvAmount, tvDate,
